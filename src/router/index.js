...
export const asyncRouterMap = [
...

    {
        ...
        children: [{
            path: 'platform',
            component: () => import('@/views/orders/platform'),
            name: 'platformOrders',
            meta: {
                title: 'platformOrders',
                roles: ['admin'] // or you can only set roles in sub nav
            }
        }, {
            path: 'group',
            component: () => import('@/views/orders/group'),
            name: 'groupOrders',
            meta: {
                title: 'groupOrders'
...

    {
        ...
        children: [{
            path: 'administrator',
            component: () => import('@/views/settings/administrator'),
            ...
            path: 'groupleader',
            component: () => import('@/views/settings/groupleader'),
            name: 'groupleaderSettings',
            meta: {
                title: 'groupleaderSettings'
                // if do not set roles, means: this page does not require permission
            }
        }]
    },
